import { ArrowDownNarrowWide, ChevronDown, LayoutGrid, List, Search } from "lucide-react";
  ...
  return (
    <div className="flex items-center gap-1" aria-label="Project view">
      <button
        ...
        className={cn(
          "inline-flex size-9 items-center justify-center rounded-md text-[var(--projects-muted)] transition-colors hover:text-[var(--projects-text)]",
...
export function ProjectToolbar({
  ...
  return (
    <div className="flex flex-wrap items-center gap-2.5">
      ...
      <label className="relative inline-flex h-10 min-w-[126px] items-center rounded-md border border-[var(--projects-border-hover)] bg-[var(--projects-surface)]">
        ...
        <select
          ...
          className="h-full w-full appearance-none bg-transparent px-3 pr-8 text-xs font-medium text-[var(--projects-text)] outline-none"
        >
      ...
      <button
        ...
        className="inline-flex h-10 items-center gap-2 rounded-md border border-[var(--projects-border-hover)] bg-[var(--projects-surface)] px-3 text-xs font-semibold leading-4 text-[var(--projects-text)] transition-colors hover:bg-white/[0.035]"
      >
        <ArrowDownNarrowWide size={14} strokeWidth={1.8} className="text-[var(--projects-muted)]" aria-hidden="true" />
        {sort === "name-asc" ? "Sorted by name" : "Sorted by name (Z–A)"}
      </button>

      <div className="ml-auto flex w-full items-center justify-between rounded-md border border-[var(--projects-border)] bg-[var(--projects-surface)] p-0.5 sm:w-auto sm:justify-start">
